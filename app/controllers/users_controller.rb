class UsersController < ApplicationController
  before_action :logged_in_user, except: %i(show create new).freeze
  before_action :find_user, except: %i(index create new).freeze
  before_action :correct_user, only: %i(edit update).freeze
